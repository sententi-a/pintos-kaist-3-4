...
__do_fork (void *aux) {
	...
	/*################Newly added in Project 2################*/
	/*------------------Process System Call-----------------*/
	/* Duplicates parent's file and put it into child's (current thread's) fdt*/
	/* If parent's fdt is something wrong */
